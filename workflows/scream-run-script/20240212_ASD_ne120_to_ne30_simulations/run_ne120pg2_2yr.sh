...
# --- Configuration flags ----
# Location of output control files
readonly OUT_ROOT="/g/g17/donahue5/Code/e3sm/nudge-to-fine-scream-workflow/output_control_files"

# Machine
readonly MACHINE="ruby"  # "quartz"

# Code and compilation
readonly CASENAME_CHECKOUT="20240215"
...
readonly RESOLUTION="ne120pg2_ne120pg2"
...
$OUT_ROOT/scream_output.2dLandReplacementOutput.yaml,\
$OUT_ROOT/scream_output.3dNudgingOutput.yaml,\
$OUT_ROOT/scream_output.3dNudgingOutput_novert.yaml,\
$OUT_ROOT/scream_output.coarsened_diags_novert.yaml,\
$OUT_ROOT/scream_output.3dNative.yaml,\
$OUT_ROOT/scream_output.coarsened_diags.yaml"
# readonly OUTPUT_YAML_FILES=""
...
#    readonly CASE_ROOT="/usr/workspace/${USER}/EAMxx/${CASE_NAME}"
    readonly CASE_ROOT="/p/lustre2/${USER}/Corrective_ML/${CASE_NAME}"
    # Additional settings
...
readonly WALLTIME="02:40:00"
readonly STOP_OPTION="nmonths"
readonly STOP_N="1"
readonly REST_OPTION="nmonths"
readonly REST_N="1"
readonly RESUBMIT="23"
...
runtime_options() {
    ...
    cat <<EOF >> user_nl_elm
        finidat='/usr/gdata/climdat/eamxx-ml/simulations/t.se62-mar27.F2010-SCREAMv1.ne120pg2_ne120pg2.pm-gpu.n085t4xX.L128.vth200/run/t.se62-mar27.F2010-SCREAMv1.ne120pg2_ne120pg2.pm-gpu.n085t4xX.L128.vth200.elm.r.0003-12-01-00000.nc'
        !Land output request
        hist_nhtfrq = -168
        hist_mfilt  = 52
        hist_fincl1 = 'SOILWATER_10CM'
EOF
    # Run type
    ...
    # The restart options in EAMxx are locked to match CIME options, so we just need to rerun case_setup
    ./case.setup 
